...
for (i = 0; i < knownNpcList.length; i++) { 
  ...
  document.write('<td><select id="ammo'+i+'"><option value="1">X1</option><option value="2">X2</option><option value="3">X3</option><option value="4">X4</option><option value="11">X1 + SAB</option><option value="21">X2 + SAB</option><option value="31">X3 + SAB</option><option value="45">X4 + RSB</option></select></td>');
